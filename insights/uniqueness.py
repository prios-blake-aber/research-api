...
def author_disagrees_with_believable_view_on_action_153(x: objects.AssertionSet):
    ...
    * This is produced by the following operation(s):
        * Compares the Author’s View to the Believable View using the [Substantive Disagreement](https://blakea-analytics-registry.dev.principled.io/writeup?analytic=129)
     library method
    """
    pass
